...
- **실제 발행:** [네이버 블로그 alice8401](https://blog.naver.com/alice8401)
- 스크린샷: `images/01-blog-pipeline/`

### 2. 부동산 데이터 수집 (호갱노노 + 국토부 실거래가)

- **구현:** `harness-engineering-guide/templates/agents/web_data_scraper.py`
- 지식산업센터 시세 브리핑 / 재건축·재개발 일일 추적
- 스크린샷: `images/02-realestate/`
...
- 6월 하프마라톤 · 11월 풀마라톤 준비
- 스크린샷: `images/04-marathon/`

### 5. 텔레봇 이안 (아침 7시 일정 · 뉴스 · 부동산 이슈)

- 07:00 데일리 노트 · 07:05 아침 브리핑 · 17:00 문자 요약 · 17:50 저녁 브리핑
- 부동산 이슈 자동 스캔 후 즉시 텔레그램 알림
- 스크린샷: `images/05-telegram/`
